...
<body onload="document.getElementById('rect').click()">
    <?php
        ...
        //ATUALIZA A PAGINA
        $botaoPesquisar = "<hr><button style='padding:10px;font-family:sans;font-size:1em;color:#FFF;background:#000;border-radius:10px;' onclick='javascript:location.reload()'> Pesquisar novamente </button>";
    ?>
